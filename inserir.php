...
<html lang="pt-br">
  ...
  <body style="background-color: #f5fefd;">
    ...
    <div class="w3-container rightside r2">
      <h3 style="font-family: 'Roboto', sans-serif;">CADASTRAR PRODUTO</h3>
    </div>
    ...
    <div id="modal" class="w3-animate-opacity">
      <div class="w3-container">
        ...
        <form id="form" method="post">
          <div class="w3-container w3-margin">
            <span style="font-family: 'Roboto', sans-serif;"><b>EMPRESA</b></span><input id="empresa" type="number" class="w3-input w3-border w3-round w3-border-blue" name="empresa" style="width: 30%;">
            <span id="Empmsg" class="w3-text-red"></span><br></br>

            <div class="w3-row w3-round w3-padding-32" style="background-color: #ecf5ee;">
              <div class="w3-col m4 l4">
                <span style="font-family: 'Roboto', sans-serif;"><b>PRODUTO</b></span><input id="prodProd" type="text" class="w3-input w3-border w3-round w3-border-blue" name="prodProd">
                <span id="Prodmsg" class="w3-text-red"></span><br>
              </div>
              <div class="w3-col m3 l3">&nbsp</div>
              <div class="w3-col m4 l4">
                <span class="w3-col l4" style="font-family: 'Roboto', sans-serif;"><b>DESCRICAO_PRODUTO</b></span><input id="descProd" type="text" class="w3-input w3-border w3-round w3-border-blue" name="descProd">
              </div>
            </div></br>
            ...
            <div class="w3-row w3-round w3-padding-32">
              <div class="w3-col m4 l4">
                <span class="w3-col l4" style="font-family: 'Roboto', sans-serif;"><b>APELIDO_PRODUTO</b></span><input id="apelidProd" type="text" class="w3-input w3-border w3-round w3-border-blue" name="apelidProd">
              </div>
              <div class="w3-col m3 l3">&nbsp</div>
              <div class="w3-col m4 l4">
            ...
            <div class="w3-row w3-round w3-padding-32" style="background-color: #ecf5ee;">
              <div class="w3-col m4 l4">
                <span style="font-family: 'Roboto', sans-serif;"><b>SUBGRUPO_PRODUTO</b></span><input id="subgrpProd" type="number" class="w3-input w3-border w3-round w3-border-blue" name="subgrpProd">
              </div>
              <div class="w3-col m3 l3">&nbsp</div>
              <div class="w3-col m4 l4">
                <span class="w3-col l4" style="font-family: 'Roboto', sans-serif;"><b>SITUACAO</b></span><input id="situacao" type="text" class="w3-input w3-border w3-round w3-border-blue" name="situacao">
              </div>
            </div></br></br>

            <div class="w3-row">
              <div class="w3-col m4 l4">
                <span style="font-family: 'Roboto', sans-serif;"><b>PESO_LIQUIDO</b></span><input id="pesoLiq" type="text" class="w3-input w3-border w3-round w3-border-blue" name="pesoLiq">
              </div>
              <div class="w3-col m3 l3">&nbsp</div>
              <div class="w3-col m4 l4">
                <span class="w3-col l4" style="font-family: 'Roboto', sans-serif;"><b>CLASSIFICACAO_FISCAL</b></span><input id="classFiscal" type="text" class="w3-input w3-border w3-round w3-border-blue" name="classFiscal">
              </div>
            </div></br></br>

            <div class="w3-row w3-round w3-padding-32" style="background-color: #ecf5ee;">
              <div class="w3-col m4 l4">
                <span style="font-family: 'Roboto', sans-serif;"><b>CODIGO_BARRAS</b></span><input id="codBarras" type="text" class="w3-input w3-border w3-round w3-border-blue" name="codBarras">
              </div>
              <div class="w3-col m3 l3">&nbsp</div>
              <div class="w3-col m4 l4">
                <span class="w3-col l4" style="font-family: 'Roboto', sans-serif;"><b>COLECAO</b></span><input id="colecao" type="text" class="w3-input w3-border w3-round w3-border-blue" name="colecao">
              </div>
            </div></br>
      ...
      <div class="w3-container w3-margin-left w3-margin-bottom">
        <div class="w3-container">
          <button onclick="connection()" class="w3-button w3-black">Cadastrar</button>
        </div>
      </div>
    </div>
      ...
      function connection(){
          ...
          } else if (descProd == "")
          {
            ...
            var http = new XMLHttpRequest();
             ...
             http.send(`empresa=${empresa}&prodProd=${prodProd}&descProd=${descProd}&apelidProd=${apelidProd}&grpProd=${grpProd}&subgrpProd=${subgrpProd}&situacao=${situacao}&pesoLiq=${pesoLiq}&classFiscal=${classFiscal}&codBarras=${codBarras}&colecao=${colecao}`);
          }
      }
    </script>
  </body>
